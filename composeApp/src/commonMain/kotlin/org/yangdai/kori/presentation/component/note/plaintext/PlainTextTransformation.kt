...
object TextFormat {
     ...
     * @hide
     */
    private const val IANA_TOP_LEVEL_DOMAINS: String = ("(?:"
     ...
     * [.IP_ADDRESS]
     */
    private const val STRICT_DOMAIN_NAME = "(?:$STRICT_HOST_NAME|$IP_ADDRESS_STRING)"
     ...
     * @hide
     */
    val AUTOLINK_WEB_URL: Regex = ("($WEB_URL_WITH_PROTOCOL|$WEB_URL_WITHOUT_PROTOCOL)").toRegex()
     ...
     * @hide
     */
    val AUTOLINK_EMAIL_ADDRESS: Regex =
        ("($WORD_BOUNDARY(?:$EMAIL_ADDRESS_LOCAL_PART@$EMAIL_ADDRESS_DOMAIN)$WORD_BOUNDARY)").toRegex()
}